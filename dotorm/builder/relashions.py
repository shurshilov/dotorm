...
# from .primary import BuilderCRUDPrimary
from .many2many import BuilderMany2many
from ..fields import Field, Many2many, Many2one, One2many


# class BuilderCRUDRelashions(BuilderCRUDPrimary, BuilderMany2many):
class BuilderCRUDRelashions(BuilderMany2many):
    @classmethod
    async def build_search_relation(
        ...
        for name, field in fields_relation:
            ...
            fields = ["id"]
            if field.relation_table.get_fields().get("name"):  # type: ignore
                fields.append("name")
